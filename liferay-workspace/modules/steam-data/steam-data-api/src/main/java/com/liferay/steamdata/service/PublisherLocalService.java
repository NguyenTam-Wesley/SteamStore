...
/**
 * Provides the local service interface for Publisher. Methods of this
...
public interface PublisherLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.steamdata.service.impl.PublisherLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the publisher local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link PublisherLocalServiceUtil} if injection and service tracking are not available.
	 */
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Publisher deletePublisher(String publisherId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Publisher fetchPublisher(String publisherId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Publisher getPublisher(String publisherId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Publisher> getPublishers(int start, int end);
