 ...
 * <code>com.liferay.steamdata.service.impl.GameLocalServiceImpl</code> and
...
public class GameLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.steamdata.service.impl.GameLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 * @return the new game
	 */
	public static Game createGame(long appId) {
		return getService().createGame(appId);
	}
	 ...
	 */
	public static Game deleteGame(Game game) {
	 ...
	 */
	public static Game deleteGame(long appId) throws PortalException {
		return getService().deleteGame(appId);
	}
	...
	public static Game fetchGame(long appId) {
		return getService().fetchGame(appId);
	}
	 ...
	 * @throws PortalException if a game with the primary key could not be found
	 */
	public static Game getGame(long appId) throws PortalException {
		return getService().getGame(appId);
	}
	 ...
	 */
	public static List<Game> getGames(int start, int end) {
	...
	public static void setService(GameLocalService service) {
		_service = service;
	}

	private static volatile GameLocalService _service;
